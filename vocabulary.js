...
const vocabData = {
    ...
    "B2": [
        ...
        {word: "Prevent", trans: "Prevenir"}, {word: "Respond", trans: "Responder; reagir"}, {word: "Influence", trans: "Influenciar"}, {word: "Assume", trans: "Supor; presumir"}, {word: "Implement", trans: "Implementar"},
        ...
        {word: "Both", trans: "Ambos"}, {word: "Each", trans: "Cada"}, {word: "Various", trans: "Diversos"}, {word: "Entire", trans: "Inteiro(a)"}, {word: "Sole", trans: "Único(a)"}
    ],
    "C1": [
        ...
        {word: "Framework", trans: "Estrutura; arcabouço"}, {word: "Controversy", trans: "Controvérsia"}, {word: "Consensus", trans: "Consenso"}, {word: "Priority", trans: "Prioridade"}, {word: "Paradigm", trans: "Paradigma"},
        ...
        {word: "Interpret", trans: "Interpretar"}, {word: "Justify", trans: "Justificar"}, {word: "Negotiate", trans: "Negociar"}, {word: "Acknowledge", trans: "Reconhecer; admitir"}, {word: "Exemplify", trans: "Exemplificar"},
        {word: "Comprehensive", trans: "Abrangente; completo"}, {word: "Substantial", trans: "Substancial"}, {word: "Crucial", trans: "Crucial; essencial"}, {word: "Consistent", trans: "Consistente"}, {word: "Coherent", trans: "Coerente"},
        {word: "Appropriate", trans: "Apropriado(a)"}, {word: "Fundamental", trans: "Fundamental"}, {word: "Convincing", trans: "Convincente"}, {word: "Sophisticated", trans: "Sofisticado(a)"}, {word: "Nuanced", trans: "Matizado(a)"},
        {word: "Undoubtedly", trans: "Sem dúvida"}, {word: "Presumably", trans: "Presumivelmente"}, {word: "Simultaneously", trans: "Simultaneamente"}, {word: "Invariably", trans: "Invariavelmente"}, {word: "Ostensibly", trans: "Ostensivamente"},
        {word: "Beyond", trans: "Além de"}, {word: "Amid", trans: "Em meio a"}, {word: "Concerning", trans: "Em relação a"}, {word: "Notwithstanding", trans: "Apesar de"}, {word: "Vis-à-vis", trans: "Em relação a"},
        {word: "Hence", trans: "Assim; portanto"}, {word: "Thereby", trans: "Desse modo; assim"}, {word: "Accordingly", trans: "Consequentemente"}, {word: "Conversely", trans: "Inversamente"}, {word: "Contrarily", trans: "Ao contrário"},
        {word: "Whoever", trans: "Quem quer que"}, {word: "Whichever", trans: "Qualquer que seja"}, {word: "Whereby", trans: "Pelo qual"}, {word: "Whether", trans: "Se; quer...quer"}, {word: "Albeit", trans: "Embora"}
    ]
};
...
function renderVocab(level) {
    ...
    document.getElementById('vocab-controls').style.display = 'flex';
...
function startQuiz() {
    ...
    // Seleciona 10 palavras aleatórias do nível
    ...
    quizWords.forEach((wordObj, index) => {
        ...
        card.innerHTML = `
            ...
            <div class="quiz-options">
                <button onclick="checkAnswer(this, '${options[0]}', '${wordObj.trans}', ${index}, 10)">${options[0]}</button>
                <button onclick="checkAnswer(this, '${options[1]}', '${wordObj.trans}', ${index}, 10)">${options[1]}</button>
                <button onclick="checkAnswer(this, '${options[2]}', '${wordObj.trans}', ${index}, 10)">${options[2]}</button>
            </div>
        `;
...
function checkAnswer(btn, selectedOption, correctOption, questionIndex, totalQuestions) {
...
document.addEventListener('DOMContentLoaded', function() {
    if (document.getElementById('vocab-display')) {
        renderVocab('A1');
    }
});
